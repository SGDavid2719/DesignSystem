...
<Meta title="Organisms/OfficesList" component={OfficesList} />

export const Template = (args) => <OfficesList {...args} />;

# Lista de oficinas

[Código fuente](https://github.com/SGDavid2719/DesignSystem/tree/master/src/stories/organisms/officesList)
...
Un elemento `<OfficesList>` se utiliza para visualizar la lista de oficinas.
...
<Props of={OfficesList} />

## Desarrollo atómico

Este componente es un organismo y está compuesto por moléculas como una lista de `<OfficeItem>`.
